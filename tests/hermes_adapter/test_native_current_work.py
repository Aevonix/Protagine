...
try:
    ...
    from protagine.turns.executions import registry, format_view
...
def environment(tmp_path):
    ...
    env.update(HERMES_HOME=str(tmp_path/'profile'),PROTAGINE_STATE_DIR=str(tmp_path/'protagine'),
        ...
        PROTAGINE_MEMORY_WORKER_TOOLS='0', PROTAGINE_MEMORY_TURN_WRITER='disabled', PROTAGINE_GUARD_CHAT_MODE='off')
    return env
