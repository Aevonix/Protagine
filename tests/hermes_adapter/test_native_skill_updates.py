...
protagine_hermes.ProtagineClient.post=lambda *args,**kwargs:Reply()
protagine_hermes.ProtagineClient.get=lambda *args,**kwargs:Reply()
...
name='protagine-cache-fixture';removed='protagine-retired-fixture';local='manual-index-local'
body_addition=''
...
for path in (current,retired):
    (path.parent/'.protagine-owned.json').write_text(json.dumps({'owner':'protagine-hermes',
