...
second=dispatch({**ref,'view':'document','asset_hash':asset,'page':2},
    session='reader',task='reader-task',turn='reader-turn',call='document-second',tool='colony_memory_read_source')
...
fresh=dispatch({**ref,'view':'document','asset_hash':asset,'page':2},
    session='reader',task='reader-task',turn='reader-turn',call='document-corrected',tool='colony_memory_read_source')
