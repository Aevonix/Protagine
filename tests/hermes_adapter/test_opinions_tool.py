"""``protagine_opinions``: reads bound to the session's participant; withdraw and reconsider owner-only.
...
the tool as read-only, so it runs even with the sidecar down.
"""
...
g, o = guest(), owner()
emit(guest_list=call("protagine_opinions", {"operation": "list", "query": "soil"}, g),
     owner_list=call("protagine_opinions", {"operation": "list"}, o),
     why=call("protagine_opinions", {"operation": "why", "id": 4}, g),
     missing=call("protagine_opinions", {"operation": "why"}, g),
     bad=call("protagine_opinions", {"operation": "flip", "id": 4}, g))
''', home)
    ...
    why, = sidecar.calls("/v1/mind/opinions/4", "GET")
    assert why["query"] == {"contact_id": "p-02"}
...
emit(guest=call("protagine_opinions", {"operation": "withdraw", "id": 4, "reason": "wrong"}, g),
     cron=call("protagine_opinions", {"operation": "reconsider", "id": 4, "reason": "look again"}, c),
     cron_list=call("protagine_opinions", {"operation": "list"}, c),
     no_reason=call("protagine_opinions", {"operation": "withdraw", "id": 4}, o),
     owner=call("protagine_opinions", {"operation": "withdraw", "id": "4", "reason": "The survey was wrong."}, o),
     again=call("protagine_opinions", {"operation": "reconsider", "id": 4, "reason": "Look again."}, o))
''', home)
...
emit(withdraw=call("protagine_opinions", {"operation": "withdraw", "id": 4, "reason": "told to"}, w),
     listing=call("protagine_opinions", {"operation": "list"}, w))
...
g = guest()
emit(guest=check("protagine_opinions", {"operation": "list"}, g),
     worker=check("protagine_opinions", {"operation": "withdraw", "id": 4, "reason": "x"}),
     listed=call("protagine_opinions", {"operation": "list"}, g))
''', home, env=worker_env(home))
