"""Reference :class:`~protagine_hostworker.store.ActionStore` on local SQLite.
...
:mod:`protagine_hostworker.store` (I1-I11) and exercised by
:mod:`protagine_hostworker.conformance`.
"""
...
RECOVERY_SCHEMA = "ProtagineDispatchObservationRecoveryV1"
OBSERVATION_SCHEMA = "ProtagineDispatchObservationAttemptV1"
