...
The client is loopback-only (see :func:`protagine_hostworker._private_io.\
...
(:func:`protagine_hostworker.worker.validate_execution_result`).
"""
    ...
    def _request(self, method: str, request: Mapping[str, Any]) -> Mapping[str, Any]:
        ...
        outbound = urllib.request.Request(
            ...
            headers={
                ...
                "X-Protagine-Principal": self.credential.principal,
