...
ADMISSION_SCHEMA = "ProtagineHostWorkerAdmissionV1"
...
class FileDispatchAdmission:
    ...
    def __init__(
        ...
        *,
        ...
        self.protagine_origin = loopback_origin(
            protagine_origin, error=DispatchAdmissionError
        )
    ...
    def fence(self) -> dict[str, Any]:
        ...
        return {
            "schema": "ProtagineHostWorkerAdmissionFenceV1",
            "admission_file": self.path,
            "protagine_origin": self.protagine_origin,
    ...
    def assert_live(self) -> None:
        ...
        if (
            ...
            or document.get("protagine_origin") != self.protagine_origin
