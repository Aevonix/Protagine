...
ADMISSION_SCHEMA = "PacoMindHostWorkerAdmissionV1"
...
class FileDispatchAdmission:
    ...
    def __init__(
        ...
        *,
        ...
        self.pacomind_origin = loopback_origin(
            pacomind_origin, error=DispatchAdmissionError
        )
    ...
    def fence(self) -> dict[str, Any]:
        ...
        return {
            "schema": "PacoMindHostWorkerAdmissionFenceV1",
            "admission_file": self.path,
            "pacomind_origin": self.pacomind_origin,
    ...
    def assert_live(self) -> None:
        ...
        if (
            ...
            or document.get("pacomind_origin") != self.pacomind_origin
