...
The client is loopback-only (see :func:`pacomind_hostworker._private_io.\
...
(:func:`pacomind_hostworker.worker.validate_execution_result`).
"""
    ...
    def _request(self, method: str, request: Mapping[str, Any]) -> Mapping[str, Any]:
        ...
        outbound = urllib.request.Request(
            ...
            headers={
                ...
                "X-PacoMind-Principal": self.credential.principal,
