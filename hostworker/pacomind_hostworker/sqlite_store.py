"""Reference :class:`~pacomind_hostworker.store.ActionStore` on local SQLite.
...
:mod:`pacomind_hostworker.store` (I1-I11) and exercised by
:mod:`pacomind_hostworker.conformance`.
"""
...
RECOVERY_SCHEMA = "PacoMindDispatchObservationRecoveryV1"
OBSERVATION_SCHEMA = "PacoMindDispatchObservationAttemptV1"
