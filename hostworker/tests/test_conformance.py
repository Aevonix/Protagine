...
new invariant is added to :mod:`pacomind_hostworker.store`, add both a case
...
from pacomind_hostworker.gate import GateAuthorization
...
def test_module_runner_reports_reference_success(capsys):
    from pacomind_hostworker.conformance.__main__ import main
