...
new invariant is added to :mod:`protagine_hostworker.store`, add both a case
...
from protagine_hostworker.gate import GateAuthorization
...
def test_module_runner_reports_reference_success(capsys):
    from protagine_hostworker.conformance.__main__ import main
