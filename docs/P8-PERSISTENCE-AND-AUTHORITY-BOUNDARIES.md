...
unless `PROTAGINE_RECIPIENT_SIMULATOR_MODE=shadow` is explicit. It appends a
...
Generic Protagine identity, capability/skill descriptions, product self-knowledge,
