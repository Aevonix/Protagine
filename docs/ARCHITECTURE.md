...
Protagine supplies persistent cognition to a host runtime. A private deployment
...
| Protagine | Durable experience, knowledge, identity-state representation, relationships, commitments, work coordination, authority, consent and evaluated learning. |
...
Identity mechanisms belong in Protagine; a particular identity belongs to its
...
device provisioning and fleet inventories are not prerequisites for Protagine.
...
do; grants determine what it may do. Protagine can remember a resource and its
