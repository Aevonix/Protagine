...
| Dev split for the pilot | seed 7, `--per-template 3`, 39 episodes (18 treatment, 21 control); loader content hash `19fe948794166d2b31d2e1755c0188f627d422ac4e792e99842440e1de6133db`; rendered dev directories carry it in their manifest |
