...
class ColonyMemoryProvider(_MemoryProviderABC):
    ...
    def _resolve_handle(self, platform: str, sender: str) -> Optional[str]:
        ...
        if not sender:
            return None
        try:
            from apsimo_hermes.native_task_platform import bound_task_contact
    ...
    def sync_turn(
        ...
        *,
        ...
        if not self._turn_writer_enabled():
            ...
            return
        try:
            from apsimo_hermes.evidence import native_work_capture_excluded
        except ImportError:
    ...
    def on_turn_start(self, turn_number: int, message: str, **kwargs) -> None:
        ...
        try:
            from apsimo_hermes.native_input import capture
    ...
    def on_pre_compress(
        ...
        try:
            ...
            from apsimo_hermes.evidence import checkpoint
            import yaml
            home = Path(self._hermes_home)
