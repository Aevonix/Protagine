...
for name in __init__.py client.py events.py evidence.py executions.py commitment_work.py local_work.py local_work_runner.py request_memory.py slash.py plugin.yaml; do
