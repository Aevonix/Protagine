...
The canonical PacoMind sidecar integration has a zero-patch Hermes target. The
...
required behavior to a Hermes plugin/config seam or an external PacoMind adapter,
