"""PacoMind Contacts — SQLite-backed ContactStore."""
...
logger = logging.getLogger("pacomind.contacts.store")
...
class SQLiteContactStore(ContactStore):
    ...
    async def connect(self) -> None:
        ...
        from pacomind.migrations import run_migrations
    ...
    async def record_introduction(
        ...
        Used when an intro names someone PacoMind already knows: we record who
    ...
    async def set_timezone(
        ...
        from pacomind.util.temporal import is_valid_timezone
