...
class SkillRegistry:
    ...
    def _load_builtin_skills(self) -> None:
        ...
        builtin_skills = [
            "pacomind.skills.executors.subsystem_health",
            "pacomind.skills.executors.data_quality",
            "pacomind.skills.executors.operational_hygiene",
            "pacomind.skills.executors.capability_gap",
            "pacomind.skills.executors.knowledge_acquisition",
            "pacomind.skills.executors.behavioral_correction",
        ]
