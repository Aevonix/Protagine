"""PacoMind Skills — packaging extracted patterns as skill directories."""
...
from pacomind.skills.learning.pattern_extractor import ExtractedPattern
from pacomind.skills.learning.triggers import TriggerSource
from pacomind.skills.models import SkillCapability, SkillManifest, SkillPermissions, SkillStatus
from pacomind.skills.registry import SkillRegistry

logger = logging.getLogger(__name__)

_SLUG_RE = re.compile(r"[^a-z0-9-]")
_SKILL_LIBRARY_PATH = pathlib.Path("pacomind/skills/library")
...
class SkillPackager:
    ...
    async def package(
        ...
        manifest = SkillManifest(
            ...
            author_pacomind_id=self._pacomind_id,
            created_at=now,
            updated_at=now,
        ...
        (skill_dir / "pacomind.skill.json").write_text(manifest.to_json(), encoding="utf-8")
