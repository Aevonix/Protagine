"""PacoMind Skills — on-demand skill module loader."""
...
from pacomind.skills.budget import ContextBudget
from pacomind.skills.index import SkillEntry, SkillIndex
...
_ALLOWED_LAZY_LOADER_PREFIXES = frozenset({"pacomind.skills.", "pacomind.plugins."})
