"""PacoMind Skills — data models for the self-creating skills subsystem."""
...
@dataclass
class SkillManifest:
    """Complete metadata for a PacoMind skill.

    Stored as pacomind.skill.json alongside the skill source.
    """
    skill_id: str
    name: str
    version: str
    description: str
    author_pacomind_id: str
    created_at: datetime
    updated_at: datetime
    ...
    def to_json(self) -> str:
        """Serialize to JSON for storage as pacomind.skill.json."""
        d = {
            "skill_id": self.skill_id,
            "name": self.name,
            "version": self.version,
            "description": self.description,
            "author_pacomind_id": self.author_pacomind_id,
    ...
    def from_json(cls, raw: str) -> "SkillManifest":
        ...
        return cls(
            ...
            author_pacomind_id=d["author_pacomind_id"],
