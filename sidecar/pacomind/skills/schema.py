"""PacoMind Skills — SQLite schema for the skill registry."""
...
CREATE TABLE IF NOT EXISTS skills (
    ...
    author_pacomind_id  TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_skills_author    ON skills(author_pacomind_id);
...
CREATE TABLE IF NOT EXISTS skill_attestations (
    id                INTEGER PRIMARY KEY AUTOINCREMENT,
    skill_id          TEXT NOT NULL,
    attesting_pacomind  TEXT NOT NULL,
