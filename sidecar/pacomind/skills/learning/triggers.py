"""PacoMind Skills — learning triggers and coordination service."""
...
class TriggerCoordinator:
    ...
    the pacomind EventBus instance after construction.
    """
...
class LearningTriggerEvent:
    ...
    requestor_pacomind_id: Optional[str] = None
...
class SkillLearningService:
    ...
    async def post_task_hook(self, solution: TaskSolution) -> None:
        """Wired as a post-task completion callback in pacomind/task_queue/."""
    ...
    async def explicit_remember(
        ...
        event = LearningTriggerEvent(
            ...
            solution=solution,
            force_capture=True,
            requestor_pacomind_id=requestor,
        )
