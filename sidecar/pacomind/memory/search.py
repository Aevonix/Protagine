...
async def select_memory(collected: CollectedSources, *, query: str, selector,
    ...
    """
    from pacomind.beliefs.source_time import interpret_time_query, filter_unstructured
    from pacomind.util import temporal
    ...
    try:
        max_chars = int(os.environ.get('PACOMIND_RECALL_CONTEXT_MAX_CHARS', '6000'))
