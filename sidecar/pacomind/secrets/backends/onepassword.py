...
from pacomind.secrets.types import SecretType, VAULT_NAME
...
@dataclass
class OPItem:
    """Represents a 1Password item as used by PacoMind."""
...
class OnePasswordBackend(SecretsBackend):
    ...
    Vault structure:
      - Default vault name: "PacoMind" (overridable in config)
    ...
    SECTION_MAP: dict[SecretType, str] = {
        ...
        SecretType.PACOMIND_TOKEN: "PacoMind Core",
