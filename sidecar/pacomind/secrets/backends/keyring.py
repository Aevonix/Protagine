...
from pacomind.secrets.types import SecretType, ALL_SECRET_KEYS

logger = logging.getLogger(__name__)

_SERVICE = "pacomind-ai"
...
class KeyringBackend(SecretsBackend):
    ...
    Requires: pip install keyring  (or pacomind[keyring] optional dep)
    """
    ...
    def is_available(self) -> bool:
        ...
        try:
            ...
            keyring.get_password(_SERVICE, "_pacomind_probe_")
            return True
