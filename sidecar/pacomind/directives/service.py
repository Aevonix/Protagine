...
The single entry point the rest of PacoMind uses: the turn pipeline calls
...
from pacomind.directives.guard import DirectiveGuard, Action, Verdict
...
# sentence FRAGMENTS ("that and wipe it from pacomind", "or manage this job",
...
class DirectiveManager:
    ...
    def capture_from_message(self, message: str, *, source: str = "owner_explicit",
        ...
        try:
            from pacomind.delivery.reachout_policy import is_system_origin
    ...
    async def flag_critical(self, subject: str, finding: str,
        ...
        import os
        try:
            threshold = float(os.environ.get("PACOMIND_BOUNDARY_FLAG_MIN_SEVERITY", "0.85"))
