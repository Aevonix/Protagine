"""FederationSession — pacomind-to-pacomind isolated session."""
...
class FederationSession:
    """PacoMind-to-pacomind session. Contains ONLY bilateral negotiation content.

    MUST NOT contain:
    - Content from contact sessions.
    - Internal deliberation memories (PACOMIND_ONLY).
    - Any information about local contacts.
    """
    session_id: str
    local_pacomind_id: str
    remote_pacomind_id: str
    federated_trust_tier: str           # e.g. "trusted_pacomind" | "untrusted" | "newly_paired"
    ...
    def create(
        ...
        return cls(
            ...
            local_pacomind_id=local_pacomind_id,
            remote_pacomind_id=remote_pacomind_id,
