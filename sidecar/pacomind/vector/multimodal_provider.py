"""PacoMind Vector — multimodal embedding providers.
...
from pacomind.vector.multimodal_types import EmbedInput, EmbedResult, ImageInput, Modality
...
class MultimodalEmbeddingProvider(ABC):
    ...
    async def warmup(self) -> None:
        ...
        try:
            _ = await self.embed_text("pacomind multimodal warmup")
    ...
    async def health_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            t0 = time.monotonic()
            text_vec = await self.embed_text("pacomind health check")
            ...
            from pacomind.vector.image_preprocess import compute_image_hash
