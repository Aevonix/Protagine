"""PacoMind Briefing System — data aggregators.

Thin adapter layer that pulls structured data from PacoMind intelligence
...
class ConnectorCalendarAggregator:
    ...
    PACOMIND_CONNECTOR_CALENDAR_ENABLED so it can't surprise-fetch.
    ...
    def _events_between(self, start_utc: datetime,
        ...
        try:
            ...
            zone = timezone.utc
        from pacomind.connectors.caldav_calendar import _ics_ts
        dated: List[Any] = []
