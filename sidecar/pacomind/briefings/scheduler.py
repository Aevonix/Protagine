"""PacoMind Briefing System — scheduling engine.
...
class TacticalBriefingTrigger:
    """Subscribe to PacoMind events and fire tactical briefings as needed."""
    ...
    def on_event(self, event_type: str, payload: Dict[str, Any]) -> Optional[Briefing]:
        """Handle a PacoMind event and fire a tactical briefing if warranted."""
