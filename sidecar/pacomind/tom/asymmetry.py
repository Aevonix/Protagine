...
Modes (PACOMIND_TOM2): off (default, engine is inert) | shadow (counts only,
...
def tom2_mode() -> str:
    ...
    return resolve("PACOMIND_TOM2", ("off", "shadow", "live"), "off")


def tom2_context_enabled() -> bool:
    """PACOMIND_TOM2_CONTEXT (default 0, H3.3): may tom2 inferences be
    ...
    return os.environ.get("PACOMIND_TOM2_CONTEXT", "0").strip().lower() in (
        "1", "true", "yes", "on")
