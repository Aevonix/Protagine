...
from pacomind.self_model.store import CompetenceStore, event_fingerprint
...
def dry_run(db_path: Path, manifest: Dict[str, Any]) -> Dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="pacomind-competence-dryrun-") as td:
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Inspect or reconcile PacoMind competence evidence")
