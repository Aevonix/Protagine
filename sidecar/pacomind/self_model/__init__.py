...
SelfModel is enabled by default (PACOMIND_SELF_MODEL_ENABLED); individual outcome
...
from pacomind.self_model.store import CompetenceStore, SelfModel, self_model_enabled
from pacomind.self_model.brief import self_brief
from pacomind.self_model.journal import ActionJournal
from pacomind.self_model.trust import TrustEngine, floor_class, autograduate_enabled
