...
_OUTCOME_SOURCE_KINDS = frozenset({
    "pacomind_event", "host_event", "transport_receipt", "service_probe",
...
def expectations_mode() -> str:
    """Effective PACOMIND_EXPECTATIONS: explicit env > autonomy preset > off.
    ...
    return resolve("PACOMIND_EXPECTATIONS", ("off", "on", "shadow", "live"),
                   "off")
...
# Backwards-compatible public name used throughout PacoMind.  Existing V1 rows
