...
PACOMIND_SUPERVISED_LIVE_DOMAINS (comma-separated, default EMPTY = rung off
...
Legacy alias: PACOMIND_BELIEFS_SUPERVISED_LIVE=1 still enables the rung for
...
_LEGACY_ALIASES: Dict[str, str] = {
    "beliefs": "PACOMIND_BELIEFS_SUPERVISED_LIVE",
}
