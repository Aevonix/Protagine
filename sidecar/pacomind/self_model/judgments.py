...
def enabled():
    ...
    return os.environ.get('PACOMIND_SELF_JUDGMENTS_ENABLED') == '1'
...
def _interval():
    value = float(os.environ.get('PACOMIND_SELF_JUDGMENT_INTERVAL_SECONDS', '86400'))
...
class SelfJudgments:
    ...
    def _premises(self, conn, turn_id, message_hash):
        ...
        result = []
        from pacomind.beliefs.source_claims import admission_metadata
        for row in rows:
            ...
            if claim.get('subject_basis_claim_id'):
                from pacomind.beliefs.source_projection import subject_basis
