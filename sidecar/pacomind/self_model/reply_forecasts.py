...
from pacomind.contacts.transport_ingress import TransportIngress
...
def _parts():
    ...
    owner = (os.environ.get('PACOMIND_OWNER_PERSON_ID') or os.environ.get('PACOMIND_OWNER_CONTACT_ID', '')).strip()
...
def _parent_current(ledger, commitments, conditions, owner):
    from pacomind.api.routers.temporal_followups import source_bindings
