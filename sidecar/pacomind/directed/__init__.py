...
Option A architecture: PacoMind never mutates external systems itself. It
...
from pacomind.directed.models import (
    ScopedTask, ScopedTaskStore, ScopeLimits, READ_OPS, MUTATE_OPS,
)
from pacomind.directed.intake import scope_from_directive, resolve_targets
from pacomind.directed.audit import audit_completion, audit_via_report
from pacomind.directed.service import DirectedActionService, directed_mode
