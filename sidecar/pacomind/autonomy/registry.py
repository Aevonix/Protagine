...
class SubsystemRegistry:
    ...
    @property
    def graph(self) -> Any:
        from pacomind.api.routers.host import _graph
        return _graph

    @property
    def goals(self) -> Any:
        from pacomind.api.routers.host import _goals_store
        return _goals_store

    @property
    def world_model(self) -> Any:
        from pacomind.api.routers.host import _world_store
        return _world_store

    @property
    def directives(self) -> Any:
        from pacomind.api.routers.host import _directive_manager
        return _directive_manager

    @property
    def research(self) -> Any:
        from pacomind.api.routers.host import _research_pipeline
        return _research_pipeline

    @property
    def proposal_store(self) -> Any:
        from pacomind.api.routers.host import _proposal_store
        return _proposal_store

    @property
    def feedback_store(self) -> Any:
        from pacomind.api.routers.host import _feedback_store
        return _feedback_store

    @property
    def repo_mirrors(self) -> Any:
        from pacomind.api.routers.host import _repo_mirrors
        return _repo_mirrors

    @property
    def directed_service(self) -> Any:
        from pacomind.api.routers.host import _directed_service
        return _directed_service

    @property
    def initiative(self) -> Any:
        from pacomind.api.routers.host import _metalearner
        return _metalearner  # InitiativeEngine is part of cognition

    @property
    def anomalies(self) -> Any:
        from pacomind.intelligence.components.anomaly_detector import AnomalyDetector
        from pacomind.api.routers.host import _graph
    ...
    def briefings(self) -> Any:
        from pacomind.api.routers.host import _briefings_engine
        return _briefings_engine

    @property
    def events(self) -> Any:
        from pacomind.api.routers.host import _event_subscribers
        return _event_subscribers

    @property
    def delivery(self) -> Any:
        from pacomind.api.routers.host import _delivery_bridge
        return _delivery_bridge

    @property
    def p8(self) -> Any:
        """Shadow-only P8 integration runtime, when explicitly attached."""
        from pacomind.api.routers.host import _p8_runtime
        return _p8_runtime
    ...
    def connection_discoverer(self) -> Any:
        from pacomind.api.routers.host import _connection_discoverer
        return _connection_discoverer

    @property
    def learner(self) -> Any:
        from pacomind.api.routers.host import _learner
        return _learner

    @property
    def skills(self) -> Any:
        from pacomind.api.routers.host import _skills_registry
        return _skills_registry

    @property
    def chain(self) -> Any:
        from pacomind.api.routers.host import _chain_manager
        return _chain_manager

    @property
    def secrets(self) -> Any:
        from pacomind.api.routers.host import _secrets_manager
        return _secrets_manager

    @property
    def signal_collector(self) -> Any:
        from pacomind.api.routers.host import _signal_collector
        return _signal_collector

    @property
    def embedder(self) -> Any:
        from pacomind.api.routers.host import _embedder
        return _embedder

    @property
    def response_gate(self) -> Any:
        from pacomind.api.routers.host import _response_gate
    ...
    def scheduler(self) -> Any:
        from pacomind.api.routers.host import _scheduler
        return _scheduler
    ...
    def initiative_engine(self) -> Any:
        ...
        if not hasattr(self, '_initiative_engine'):
            try:
                from pacomind.intelligence.components.initiative_engine import InitiativeEngine
                from pacomind.api.routers.host import _graph, _initiative_store, _goals_store
    ...
    def commitment_store(self) -> Any:
        ...
        from pacomind.api.routers.host import _commitment_store  # singular
        return _commitment_store

    @property
    def benchmark(self) -> Any:
        """Get the SelfhoodBenchmark (Mind M0a)."""
        from pacomind.api.routers.host import _benchmark
        return _benchmark

    @property
    def experiments(self) -> Any:
        """Get the ExperimentEngine (Mind M0b)."""
        from pacomind.api.routers.host import _experiments
        return _experiments

    @property
    def toolsmith(self) -> Any:
        """Get the Toolsmith engine (Mind M1)."""
        from pacomind.api.routers.host import _toolsmith
        return _toolsmith

    @property
    def workspace(self) -> Any:
        """Get the WorkspaceEngine (Mind M2)."""
        from pacomind.api.routers.host import _workspace
        return _workspace

    @property
    def expectations(self) -> Any:
        """Get the ExpectationEngine (Mind M3a)."""
        from pacomind.api.routers.host import _expectations
        return _expectations

    @property
    def affect_store(self) -> Any:
        """Get the AffectStore."""
        from pacomind.api.routers.host import _affect_store
        return _affect_store

    @property
    def pattern_store(self) -> Any:
        """Get the PatternStore."""
        from pacomind.api.routers.host import _pattern_store
    ...
    def contacts(self) -> Any:
        ...
        from pacomind.api.routers.host import _contacts_store
    ...
    def worker_governor(self) -> Any:
        ...
        from pacomind.api.routers.host import _worker_governor
        return _worker_governor

    @property
    def sandbox(self) -> Any:
        """SandboxManager: gated, isolated code execution (item 6)."""
        from pacomind.api.routers.host import _sandbox
        return _sandbox

    @property
    def connector_manager(self) -> Any:
        """ConnectorManager: read-only pull senses (item 2)."""
        from pacomind.api.routers.host import _connector_manager
