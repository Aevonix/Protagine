...
from pacomind.goals.models import GoalPriority, GoalSource, GoalStatus
...
class ConversationSynthesisTask:
    ...
    def __init__(
        ...
        self.state_file = state_file or (Path.home() / ".pacomind" / "data" / "autonomy_synthesis.json")
    ...
    async def run(self) -> Dict[str, Any]:
        ...
        for cand in unique_candidates:
            ...
            from pacomind.delivery.reachout_policy import (
    ...
    async def _fetch_recent_memories(
        ...
        # Support both PacoMindGraph (driver.session) and mock with execute()
