...
One row per (domain, entity_id) — the latest snapshot wins. PacoMind's
...
OBSERVATION_DOMAINS = (
    ...
    # OBSERVATION_SYNC_ACTIONS and is NOT in the PACOMIND_SYNC_DOMAINS
...
class ObservationStore:
    ...
    def __init__(self, state_dir: Optional[Path] = None):
        if state_dir is None:
            from pacomind.initiatives.store import get_state_dir
