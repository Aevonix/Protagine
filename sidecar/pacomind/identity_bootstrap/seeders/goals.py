...
class GoalsSeeder:
    ...
    async def seed(self, corpus: Any) -> None:
        try:
            ...
            from pacomind.goals.models import Goal, GoalStatus, GoalSource, GoalPriority, GoalOutcome
        ...
        bootstrap_goal_id = f"goal-bootstrap-selfknowledge-{pacomind_id[:8]}"
        try:
        ...
        goals = [
            Goal(
                ...
                description=(
                    ...
                    "refresh the self-knowledge corpus when PacoMind is updated, "
            ...
            Goal(
                goal_id=f"goal-bootstrap-health-{pacomind_id[:8]}",
                title="Maintain system health",
                description=(
                    "Monitor and maintain PacoMind subsystem health. "
                ...
                outcome=GoalOutcome(
                    description="All PacoMind subsystems operational.",
                    success_criteria=[
            ...
            Goal(
                goal_id=f"goal-bootstrap-learning-{pacomind_id[:8]}",
