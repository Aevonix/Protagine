"""GoalEngine — top-level coordinator for the PacoMind Goal Engine.
...
from pacomind.goals.decomposer import GoalDecomposer
...
from pacomind.goals.priority import GoalProgressTracker, GoalPriorityScorer, UserPreferenceProfile
from pacomind.goals.queue_bridge import GoalQueueBridge
from pacomind.goals.replan import (
    FailureAnalysis,
    ReplanEngine,
    ReplanResult,
    ReplanStrategy,
)
from pacomind.goals.store import GoalNotFoundError, GoalStore
from pacomind.task_queue.models import JobResult

logger = logging.getLogger(__name__)


class GoalEngine:
    """Top-level coordinator for the PacoMind Goal Engine.
    ...
    def get_active_summary(self) -> List[GoalSummary]:
        ...
        for goal in active_goals:
            ...
            from pacomind.goals.models import SubtaskStatus
            completed = (
    ...
    def trigger_replan(
        ...
        if failed is None:
            ...
            from pacomind.goals.replan import FailureAnalysis, FailureClass
