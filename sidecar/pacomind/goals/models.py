"""PacoMind Goal Engine — core data models.

Defines Goal, Subtask, GoalDAG and supporting types for the
PacoMind DAG-based goal decomposition and lifecycle management system.
"""
...
class GoalSource(str, Enum):
    ...
    DELEGATED  = "delegated"   # Sent by another PacoMind agent via federation
