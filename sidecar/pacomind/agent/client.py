"""PacoMind Agent Client — WebSocket client for remote agents.

Usage:
    from pacomind.agent import AgentClient

    client = AgentClient(config_path="~/.pacomind/agent.json")
...
class AgentClient:
    """WebSocket client for remote PacoMind agents.
    ...
    def __init__(
        self,
        config_path: str = "~/.pacomind/agent.json",
    ...
    async def start(self) -> None:
        """Connect to PacoMind and start message loop."""
    ...
    async def _connect(self) -> None:
        ...
        print(f"Connected to PacoMind: {self.config.websocket_url}")
    ...
    async def _heartbeat_loop(self) -> None:
        ...
        # The pacomind side tracks current_assignments via the agents table
