...
def cognition_spine_mode() -> str:
    ...
    value = os.environ.get("PACOMIND_COGNITION_SPINE", "off").strip().lower()
    ...
    def for_concern(
        ...
        *,
        ...
        subject_person_id = str(
            ...
            or os.environ.get("PACOMIND_OWNER_PERSON_ID", "").strip()
...
class ThoughtProposalPresentationSink:
    ...
    def put_if_absent(self, route: Mapping[str, Any]) -> str:
        from pacomind.proposals import Proposal
...
class CognitionSpine:
    ...
    def runtime_contract(self) -> Any:
        ...
        from pacomind.cognition.drive_governance import drive_governance_mode
    ...
    def _record_runtime_admission(
        ...
        *,
        ...
        if str(getattr(item, "producer_name", "") or "") == (
            ...
            from pacomind.self_model.event_concerns import turn_concern_mode
            revisions["runtime_revision"] = (
