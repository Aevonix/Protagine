"""Cognition prompt templates for PacoMind's background thinking.

The cognition prompt tells the subagent what PacoMind can do and how to
...
_GUIDE = """\
You have access to PacoMind's API through HTTP endpoints running on the same \
