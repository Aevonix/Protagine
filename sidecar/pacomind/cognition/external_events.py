...
is projected into PacoMind's existing durable host event journal.
"""
...
def validate_external_journal_projection(
    ...
    configured_owner = (
        os.environ.get("PACOMIND_OWNER_PERSON_ID", "")
    ...
    def __init__(
        ...
        *,
        ...
        if journal_acknowledger is None:
            from pacomind.events.journal import acknowledge_event_record
