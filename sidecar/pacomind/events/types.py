"""Event type definitions for PacoMind's event bus.

Typed events carry structured payloads across PacoMind subsystems.
...
from pacomind.models.memory import Memory
from pacomind.models.signal import Signal
...
class Event:
    ...
    All PacoMind events inherit from this. Provides identity, timing,
    and source tracking.
...
class CognitionEvent(Event):
    ...
    Emitted by PacoMind's cognitive subsystems (metalearner, synthesis,
