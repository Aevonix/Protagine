"""Channel registration store -- backed by pacomind-channels.db.

Tracks which channels are registered with this PacoMind instance, their
...
from pacomind.migrations import run_migrations_sync
