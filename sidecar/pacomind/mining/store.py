...
training-corpus exporter. Data never leaves PACOMIND_STATE_DIR.
"""
...
from pacomind.mining.models import EscalationRecord, MinedTurn
...
class MiningStore:
    ...
    def prune_turns(self, *, retention_days: int = 0,
        ...
        PACOMIND_MINING_RETENTION_DAYS / PACOMIND_MINING_MAX_TURNS. Escalation
