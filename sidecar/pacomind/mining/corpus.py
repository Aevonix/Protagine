...
SQLite; the export file is always written under PACOMIND_STATE_DIR/exports/
...
def _clean(text: str, redact: bool) -> str:
    ...
    try:
        from pacomind.delivery.reachout_policy import sanitize_text
    ...
    if redact:
        try:
            from pacomind.redact import redact_sensitive_text
...
def export_corpus(
    ...
    *,
    ...
    if contact_id is None:
        contact_id = os.environ.get("PACOMIND_OWNER_CONTACT_ID", "owner")
