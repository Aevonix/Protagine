...
PACOMIND_MINING_TURN_CAP
    Per-side verbatim capture cap in chars (default 8000).
PACOMIND_CORPUS_EXPORT_ENABLED
...
def mining_mode() -> str:
    ...
    return resolve("PACOMIND_ESCALATION_MINING",
...
def heavy_model_regex() -> str:
    return os.environ.get("PACOMIND_ESCALATION_HEAVY_RE", "")


def turn_cap() -> int:
    try:
        return max(500, int(os.environ.get("PACOMIND_MINING_TURN_CAP", "8000")))
    except ValueError:
        return 8000
