...
for the PacoMind hardware-aware distributed job scheduler.
"""
...
@dataclass
class FederatedJob:
    """A job posted by a federated peer pacomind."""

    job: Job
    source_pacomind_id: str
    source_pacomind_trust_level: int
    signature: str           # Ed25519 signature from source pacomind
