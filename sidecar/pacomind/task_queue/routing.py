...
_ROUTE_OWNER_ENV = {
    AGENT_SYNC_ROUTE: "PACOMIND_AGENT_SYNC_WORKER_NODE_ID",
    HERMES_RUN_ROUTE: "PACOMIND_HERMES_RUN_WORKER_NODE_ID",
    ACTION_PLANE_ROUTE: "PACOMIND_ACTION_PLANE_WORKER_NODE_ID",
    WORK_ORDER_ROUTE: "PACOMIND_ACTION_PLANE_WORKER_NODE_ID",
}
...
def bind_agent_action_routes(
    ...
    *,
    ...
    from pacomind.task_queue.models import JobCapabilityRequirement
...
def bind_thought_route(job: Any) -> str:
    ...
    owner = os.environ.get("PACOMIND_THOUGHT_WORKER_NODE_ID", "").strip()
    if owner:
