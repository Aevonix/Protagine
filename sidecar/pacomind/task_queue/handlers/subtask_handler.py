"""Custom subtask handler for the PacoMind task queue.
...
_SYSTEM_PROMPT = (
    "You are an PacoMind subtask worker with NO tools: you cannot browse, run "
...
class SubtaskHandler(JobHandler):
    ...
    async def _run_agent(
        ...
        try:
            from pacomind_cli.model_config import load_model_registry
