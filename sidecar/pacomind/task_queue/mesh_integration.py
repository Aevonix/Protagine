"""Mesh layer integration for the PacoMind distributed task queue.
...
pacomind/mesh/ layer without modifying it.
"""
...
class QueueMeshEventHandler:
    ...
    Subscribe this handler to the PacoMind event bus for MeshEvent types.
    ...
    def subscribe_to_event_bus(self) -> None:
        """Register this handler on the PacoMind event bus if one is configured."""
        if self._event_bus is None:
            return
        from pacomind.events.types import MeshEvent
