...
``pacomind-relationships.db`` and refreshed by the autonomy phase when a
...
def approach_guidance_enabled() -> bool:
    return os.environ.get(
        "PACOMIND_APPROACH_GUIDANCE", "true").strip().lower() != "false"
