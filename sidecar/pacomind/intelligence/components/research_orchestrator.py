...
class ResearchOrchestrator:
    ...
    Args:
        graph_client: PacoMind graph client for knowledge graph queries
        event_bus: PacoMind event bus for research lifecycle events
    ...
    async def _query_graph_source(
        ...
        """
        from pacomind.intelligence.graph.queries import RECALL_BY_ENTITY, RECALL_BY_TYPE
