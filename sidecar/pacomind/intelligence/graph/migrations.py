"""PacoMind Graph Schema Migrations.

Applies Neo4j constraints and indexes required by the PacoMind graph memory
...
(see pacomind/vector/), so these migrations create no vector index.
"""
...
# ──────────────────────────────────────────────────────────────────────
# Schema V1 — initial PacoMind graph schema
# ──────────────────────────────────────────────────────────────────────
...
async def run_migrations(
    ...
    """Apply all PacoMind graph schema migrations.
    ...
    Args:
        ...
        embedding_dimensions: Kept for API compat; vector index creation
            is now handled by LanceDB (see pacomind/vector/).
    ...
    logger.info(
        ...
        "Vector search handled by LanceDB — run 'pacomind vector setup' to configure.",
