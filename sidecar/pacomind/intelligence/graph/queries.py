"""PacoMind Graph Cypher Query Templates.

All Cypher queries used by the PacoMind intelligence layer are defined here
...
def lexical_query(text: str, max_terms: int = 16) -> str:
    ...
    from pacomind.memory.recall import lexical_terms
