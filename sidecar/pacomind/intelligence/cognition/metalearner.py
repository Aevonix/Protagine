...
class MetaLearner:
    ...
    def __init__(self, graph: "PacoMindGraph", config: Optional[MetaLearnerConfig] = None):
        self.graph = graph
    ...
    async def evaluate(self) -> "CognitivePerformanceIndex":
        ...
        if not self._performance_index:
            ...
            from pacomind.intelligence.cognition.performance_index import CognitivePerformanceIndex, CPIComponent
