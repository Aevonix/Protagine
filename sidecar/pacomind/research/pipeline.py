...
from pacomind.research.gatherer import EvidencePackage, GatherConfig, SourceGatherer
from pacomind.research.synthesizer import ResearchSynthesizer, SynthesisConfig, SynthesisReport
from pacomind.research.artifact import (
    Artifact,
    ArtifactFormat,
    ArtifactOutline,
    ArtifactRenderer,
...
class ResearchPipeline:
    ...
    async def _run_review_gate(
        ...
        try:
            ...
            from pacomind.gate.models import GatePayload, TrustTier
