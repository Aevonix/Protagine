...
:mod:`pacomind.contextgate` for the underlying machinery.
...
from pacomind.contextgate import GateConfig, prepare_context
...
class PrepareRequest(BaseModel):
    ...
    budget_tokens: int = Field(
        ...
        description=(
            ...
            "else the PACOMIND_CONTEXT_GATE_BUDGET default."
        ),
    )
...
def _tier_budget(tier_name: str) -> int:
    ...
    try:
        from pacomind.api.routers.host import get_llm_router
