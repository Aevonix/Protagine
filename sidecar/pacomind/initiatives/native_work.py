...
def contract(row):
    ...
    instructions = (
        'Perform one internal read-only evidence review with pacomind_read_work_source. '
        ...
        'Complete with pacomind_review_report(disposition="complete", summary=...), which invokes '
