...
# Pure/general information tools that do not expose PacoMind's private stores.
...
_PRIVATE_READ_TOOLS = frozenset({
    "action_journal",
    "belief_conflicts",
    "pacomind_discover_connections",
    "pacomind_get_briefing",
    "pacomind_get_relationship",
    "pacomind_list_boundaries",
    "pacomind_list_goals",
    "pacomind_memory_search",
    "pacomind_query_entities",
    "pacomind_recent_boundary_blocks",
    "list_directory",
    "list_projects",
...
_MUTATION_TOOLS = frozenset({
    "abandon_project",
    "pacomind_flag_boundary_concern",
    "pacomind_initiative_feedback",
    "pacomind_record_insight",
    "pacomind_start_research",
