...
This is the core of PacoMind's reasoning capability. It replaces the
...
from pacomind.reasoning.executor import ToolExecutor, ToolRegistryError
...
class ReasoningLoop:
    ...
    model :
        ...
        method — typically an :class:`~pacomind.router.router.LLMRouter`.
    tools :
