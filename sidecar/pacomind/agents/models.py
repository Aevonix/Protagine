"""Agent data models for multi-agent PacoMind.
...
class AgentStatus(str, Enum):
    ...
    def can_reconnect(self) -> bool:
        """Can this agent reconnect to PacoMind?"""
...
class Agent:
    ...
    Attributes:
        ...
        pacomind_id: Parent PacoMind ID
