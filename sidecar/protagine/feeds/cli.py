"""``protagine feeds`` — manage spec-driven feed instances.

Also runnable without an installed package (any python3 with PyYAML):
    PYTHONPATH=<repo>/sidecar python3 -m protagine.feeds.cli <cmd> ...
"""
...
def build_parser(prog: str = "protagine feeds") -> argparse.ArgumentParser:
...
def main(argv: list[str] | None = None, prog: str = "protagine feeds") -> None:
...
if __name__ == "__main__":
    main(prog="python3 -m protagine.feeds.cli")
