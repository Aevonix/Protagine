...
# PROTAGINE_TOM2_CROSS_CONTEXT alone therefore changes no live behavior; wiring
...
def tom2_cross_context_enabled() -> bool:
    """PROTAGINE_TOM2_CROSS_CONTEXT (default 0): first half of the double gate.
    Ships OFF by design; see the block comment above."""
    return os.environ.get("PROTAGINE_TOM2_CROSS_CONTEXT", "0").strip().lower() \
        in ("1", "true", "yes", "on")
