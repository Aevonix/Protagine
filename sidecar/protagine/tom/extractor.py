...
Uses the LLM router (same as world model entity extraction) — Protagine
does NOT build its own LLM client.

Throttled per contact and operation: max 1 extraction per
PROTAGINE_TOM_EXTRACTION_THROTTLE_MINUTES (default 5 minutes).
"""
...
from protagine.beliefs.promotion import PROMOTION_PROMPT, promotion_metadata
