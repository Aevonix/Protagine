"""GoalEngine — top-level coordinator for the Protagine Goal Engine.
...
from protagine.goals.priority import GoalProgressTracker, GoalPriorityScorer, UserPreferenceProfile
from protagine.goals.queue_bridge import GoalQueueBridge
from protagine.goals.replan import (
    FailureAnalysis,
    ReplanEngine,
    ReplanResult,
    ReplanStrategy,
)
from protagine.goals.store import GoalNotFoundError, GoalStore
from protagine.task_queue.models import JobResult

logger = logging.getLogger(__name__)


class GoalEngine:
    """Top-level coordinator for the Protagine Goal Engine.
    ...
    def get_active_summary(self) -> List[GoalSummary]:
        ...
        for goal in active_goals:
            ...
            from protagine.goals.models import SubtaskStatus
            completed = (
    ...
    def trigger_replan(
        ...
        if failed is None:
            ...
            from protagine.goals.replan import FailureAnalysis, FailureClass
