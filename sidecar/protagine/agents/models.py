"""Agent data models for multi-agent Protagine.
...
class AgentStatus(str, Enum):
    ...
    def can_reconnect(self) -> bool:
        """Can this agent reconnect to Protagine?"""
...
class Agent:
    ...
    Attributes:
        ...
        protagine_id: Parent Protagine ID
