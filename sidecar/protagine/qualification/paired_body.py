...
clocks Hermes reads, faketime-style, without touching monotonic clocks; the mind, the sidecar's
"Now" and the plugin's "Current Time" read ``time.time`` and move with them. A generated
