"""Plugin security attestation transaction types and chain state for ProtagineChain.
...
These extend the existing ProtagineChain transaction set.
"""
...
class PluginPublishPayload:
    ...
    def canonical_signing_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "publisher_protagine_id": self.publisher_protagine_id,
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "min_protagine_version": self.min_protagine_version,
            "tags": self.tags,
...
class PluginAttestationPayload:
    ...
    def canonical_signing_dict(self) -> Dict[str, Any]:
        return {
            ...
            "scanner_protagine_id": self.scanner_protagine_id,
        }
...
class PluginFlagPayload:
    ...
    def canonical_signing_dict(self) -> Dict[str, Any]:
        return {
            ...
            "plugin_hash": self.plugin_hash,
            "reporter_protagine_id": self.reporter_protagine_id,
            "severity": self.severity.value,
...
class PluginChainRecord:
    ...
    def recompute_consensus(
        ...
        Args:
            scanner_weights: Map of scanner_protagine_id -> weight (float).
        ...
        for att in self.attestations:
            w = scanner_weights.get(att["scanner_protagine_id"], 0.25)
            total += w
    ...
    def has_sentinel_safe(self, sentinel_ids: frozenset) -> bool:
        ...
        for att in self.attestations:
            if (
                att["scanner_protagine_id"] in sentinel_ids
    ...
    def has_flagged_from_trusted(self, trusted_ids: frozenset) -> bool:
        """Return True if any trusted protagine has attested FLAGGED."""
        for att in self.attestations:
            if (
                att["scanner_protagine_id"] in trusted_ids
