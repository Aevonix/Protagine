"""FederationSession — protagine-to-protagine isolated session."""
...
class FederationSession:
    """Protagine-to-protagine session. Contains ONLY bilateral negotiation content.

    MUST NOT contain:
    - Content from contact sessions.
    - Internal deliberation memories (PROTAGINE_ONLY).
    - Any information about local contacts.
    """
    session_id: str
    local_protagine_id: str
    remote_protagine_id: str
    federated_trust_tier: str           # e.g. "trusted_protagine" | "untrusted" | "newly_paired"
    ...
    def create(
        ...
        return cls(
            ...
            local_protagine_id=local_protagine_id,
            remote_protagine_id=remote_protagine_id,
