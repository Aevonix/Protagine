...
2. STALENESS: a causal edge that has gone PROTAGINE_CAUSAL_TTL_DAYS (default
...
def causal_ttl_days() -> float:
    """PROTAGINE_CAUSAL_TTL_DAYS (default 120): days without support before a
    causal edge starts decaying."""
    try:
        v = float(os.environ.get("PROTAGINE_CAUSAL_TTL_DAYS", "120"))
