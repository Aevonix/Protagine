...
identify a context (e.g. a platform conversation id). Protagine attaches no meaning to it.
...
from protagine.gate.response_guard import CrossContextGuard, GuardFinding
