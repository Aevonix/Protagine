...
class Authority:
    ...
    # Words to the owner that are not the mind's initiative: its own reports, and the reminders and
    # heads-ups the owner asked for. ``suggest`` does not hold them for the digest.
    REQUESTED_TYPES = DIGEST_TYPES + ("commitment_reminder", "commitment_due_soon")
