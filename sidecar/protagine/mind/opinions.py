...
RESPONSE_SCHEMA = {"name": "opinion_pass", "schema": {"type": "object", "anyOf": [
    ...
    {"type": "object", "additionalProperties": False,
     # Every property is required: the router sends ``strict: true`` (integration map X3); a topic view's
     # subject is "" and "no contrary evidence" is [], as the shapes in SYSTEM show.
     "required": ["action", "subject_kind", "subject", "topic", "stance", "reason", "certainty", "revise_if",
                  "premises", "contrary"],
    ...
    {"type": "object", "additionalProperties": False,
     "required": ["action", "stance_id", "stance", "reason", "certainty", "revise_if", "premises", "contrary",
                  "new_evidence"],
