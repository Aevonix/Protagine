...
from protagine.mining.corpus import export_corpus
from protagine.mining.escalations import EscalationMiner
from protagine.mining.models import corpus_export_enabled, mining_mode
...
def corpus_export(body: CorpusExportRequest) -> Dict[str, Any]:
    ...
    if not corpus_export_enabled():
        raise HTTPException(status_code=403, detail="Corpus export disabled (PROTAGINE_CORPUS_EXPORT_ENABLED)")
    try:
