...
PROTAGINE_CONNECTOR_<NAME>_<KEY>); no credentials ever live in code or tests.
...
class ConnectorConfig:
    ...
    Precedence: PROTAGINE_CONNECTOR_<NAME>_<KEY> env (an explicit deployment
    override always wins) → the Protagine secrets store at
    ...
    def __init__(self, name: str) -> None:
        ...
        self._prefix = f"PROTAGINE_CONNECTOR_{name.upper()}_"
    ...
    def get(self, key: str, default: str = "") -> str:
        ...
        if env:
            return env
        try:
            from protagine.api.routers import host as _h
...
class Connector(ABC):
    ...
    def __init__(self, account: str = "") -> None:
        ...
        # PROTAGINE_CONNECTOR_IMAP_AEVONIX_*. Several instances of one connector
