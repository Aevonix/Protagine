...
class SubsystemRegistry:
    ...
    def proposal_store(self) -> Any:
        from protagine.api.routers.host import _proposal_store
        return _proposal_store

    @property
    def feedback_store(self) -> Any:
        from protagine.api.routers.host import _feedback_store
    ...
    def directed_service(self) -> Any:
        from protagine.api.routers.host import _directed_service
        return _directed_service

    @property
    def initiative(self) -> Any:
        from protagine.api.routers.host import _metalearner
        return _metalearner  # InitiativeEngine is part of cognition

    @property
    def anomalies(self) -> Any:
        from protagine.intelligence.components.anomaly_detector import AnomalyDetector
        from protagine.api.routers.host import _graph
    ...
    @property
    def events(self) -> Any:
        from protagine.api.routers.host import _event_subscribers
        return _event_subscribers

    @property
    def delivery(self) -> Any:
        from protagine.api.routers.host import _delivery_bridge
        return _delivery_bridge

    @property
    def p8(self) -> Any:
        """Shadow-only P8 integration runtime, when explicitly attached."""
        from protagine.api.routers.host import _p8_runtime
        return _p8_runtime
    ...
    def learner(self) -> Any:
        from protagine.api.routers.host import _learner
        return _learner

    @property
    def skills(self) -> Any:
        from protagine.api.routers.host import _skills_registry
        return _skills_registry

    @property
    def chain(self) -> Any:
        from protagine.api.routers.host import _chain_manager
        return _chain_manager

    @property
    def secrets(self) -> Any:
        from protagine.api.routers.host import _secrets_manager
        return _secrets_manager

    @property
    def signal_collector(self) -> Any:
        from protagine.api.routers.host import _signal_collector
        return _signal_collector

    @property
    def embedder(self) -> Any:
        from protagine.api.routers.host import _embedder
        return _embedder

    @property
    def response_gate(self) -> Any:
        from protagine.api.routers.host import _response_gate
    ...
    def scheduler(self) -> Any:
        from protagine.api.routers.host import _scheduler
        return _scheduler
    ...
    def initiative_engine(self) -> Any:
        ...
        if not hasattr(self, '_initiative_engine'):
            try:
                from protagine.intelligence.components.initiative_engine import InitiativeEngine
                from protagine.api.routers.host import _graph, _initiative_store, _goals_store
    ...
    def commitment_store(self) -> Any:
        ...
        from protagine.api.routers.host import _commitment_store  # singular
        return _commitment_store

    @property
    def benchmark(self) -> Any:
        """Get the SelfhoodBenchmark (Mind M0a)."""
        from protagine.api.routers.host import _benchmark
        return _benchmark

    @property
    def experiments(self) -> Any:
        """Get the ExperimentEngine (Mind M0b)."""
        from protagine.api.routers.host import _experiments
        return _experiments

    @property
    def toolsmith(self) -> Any:
        """Get the Toolsmith engine (Mind M1)."""
        from protagine.api.routers.host import _toolsmith
        return _toolsmith

    @property
    def workspace(self) -> Any:
        """Get the WorkspaceEngine (Mind M2)."""
        from protagine.api.routers.host import _workspace
        return _workspace

    @property
    def expectations(self) -> Any:
        """Get the ExpectationEngine (Mind M3a)."""
        from protagine.api.routers.host import _expectations
        return _expectations

    @property
    def affect_store(self) -> Any:
        """Get the AffectStore."""
        from protagine.api.routers.host import _affect_store
        return _affect_store

    @property
    def pattern_store(self) -> Any:
        """Get the PatternStore."""
        from protagine.api.routers.host import _pattern_store
    ...
    def agent_store(self) -> Any:
        ...
        from protagine.api.routers.host import _agent_store
        return _agent_store
    ...
    def assignment_engine(self) -> Any:
        ...
        from protagine.api.routers.host import _assignment_engine
        return _assignment_engine

    @property
    def websocket_manager(self) -> Any:
        """Get the WebSocketManager for remote agent connections."""
        from protagine.api.routers.host import _websocket_manager
    ...
    def connector_manager(self) -> Any:
        ...
        from protagine.api.routers.host import _connector_manager
