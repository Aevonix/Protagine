...
from protagine.goals.models import GoalPriority, GoalSource, GoalStatus
...
class ConversationSynthesisTask:
    ...
    def __init__(
        ...
        self.state_file = state_file or (Path.home() / ".protagine" / "data" / "autonomy_synthesis.json")
    ...
    async def run(self) -> Dict[str, Any]:
        ...
        for cand in unique_candidates:
            ...
            from protagine.delivery.reachout_policy import (
    ...
    async def _fetch_recent_memories(
        ...
        # Support both ProtagineGraph (driver.session) and mock with execute()
