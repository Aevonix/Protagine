"""Event type definitions for Protagine's event bus.

Typed events carry structured payloads across Protagine subsystems.
...
from protagine.models.memory import Memory
from protagine.models.signal import Signal
...
class Event:
    ...
    All Protagine events inherit from this. Provides identity, timing,
    and source tracking.
...
class CognitionEvent(Event):
    ...
    Emitted by Protagine's cognitive subsystems (metalearner, synthesis,
