...
The single entry point the rest of Protagine uses: the turn pipeline calls
...
from protagine.directives.guard import DirectiveGuard, Action, Verdict
from protagine.directives.models import (
...
# sentence FRAGMENTS ("that and wipe it from protagine", "or manage this job",
...
class DirectiveManager:
    ...
    async def flag_critical(self, subject: str, finding: str,
        ...
        import os
        try:
            threshold = float(os.environ.get("PROTAGINE_BOUNDARY_FLAG_MIN_SEVERITY", "0.85"))
