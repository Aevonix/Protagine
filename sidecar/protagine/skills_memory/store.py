...
from protagine.skills_memory.models import Skill, signature_overlap
...
def skills_enabled() -> bool:
    return os.environ.get("PROTAGINE_SKILLS_ENABLED", "true").strip().lower() != "false"
...
def skills_max() -> int:
    try:
        return max(10, int(os.environ.get("PROTAGINE_SKILLS_MAX", str(_DEFAULT_MAX))))
