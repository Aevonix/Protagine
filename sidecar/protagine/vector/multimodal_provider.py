"""Protagine Vector — multimodal embedding providers.
...
from protagine.vector.multimodal_types import EmbedInput, EmbedResult, ImageInput, Modality
...
class MultimodalEmbeddingProvider(ABC):
    ...
    async def warmup(self) -> None:
        ...
        try:
            _ = await self.embed_text("protagine multimodal warmup")
    ...
    async def health_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            t0 = time.monotonic()
            text_vec = await self.embed_text("protagine health check")
            ...
            from protagine.vector.image_preprocess import compute_image_hash
