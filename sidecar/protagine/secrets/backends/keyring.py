...
from protagine.secrets.types import SecretType, ALL_SECRET_KEYS

logger = logging.getLogger(__name__)

_SERVICE = "protagine-ai"
...
class KeyringBackend(SecretsBackend):
    ...
    Requires: pip install keyring  (or protagine[keyring] optional dep)
    """
    ...
    def is_available(self) -> bool:
        ...
        try:
            ...
            keyring.get_password(_SERVICE, "_protagine_probe_")
            return True
