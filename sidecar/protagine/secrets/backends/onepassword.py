...
from protagine.secrets.types import SecretType, VAULT_NAME
...
@dataclass
class OPItem:
    """Represents a 1Password item as used by Protagine."""
...
class OnePasswordBackend(SecretsBackend):
    ...
    Vault structure:
      - Default vault name: "Protagine" (overridable in config)
    ...
    SECTION_MAP: dict[SecretType, str] = {
        ...
        SecretType.PROTAGINE_TOKEN: "Protagine Core",
