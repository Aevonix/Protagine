...
from protagine.self_model.store import CompetenceStore, event_fingerprint
...
def dry_run(db_path: Path, manifest: Dict[str, Any]) -> Dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="protagine-competence-dryrun-") as td:
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Inspect or reconcile Protagine competence evidence")
