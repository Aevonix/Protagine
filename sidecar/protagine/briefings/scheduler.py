"""Protagine Briefing System — scheduling engine.
...
class TacticalBriefingTrigger:
    """Subscribe to Protagine events and fire tactical briefings as needed."""
    ...
    def on_event(self, event_type: str, payload: Dict[str, Any]) -> Optional[Briefing]:
        """Handle a Protagine event and fire a tactical briefing if warranted."""
