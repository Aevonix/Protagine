"""Protagine Briefing System — data aggregators.

Thin adapter layer that pulls structured data from Protagine intelligence
...
class ConnectorCalendarAggregator:
    ...
    PROTAGINE_CONNECTOR_CALENDAR_ENABLED so it can't surprise-fetch.
    ...
    def _events_between(self, start_utc: datetime,
        ...
        try:
            ...
            zone = timezone.utc
        from protagine.connectors.caldav_calendar import _ics_ts
        dated: List[Any] = []
