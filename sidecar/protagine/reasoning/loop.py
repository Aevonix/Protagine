...
This is the core of Protagine's reasoning capability. It replaces the
...
from protagine.reasoning.executor import ToolExecutor, ToolRegistryError
...
class ReasoningLoop:
    ...
    model :
        ...
        method — typically an :class:`~protagine.router.router.LLMRouter`.
    tools :
