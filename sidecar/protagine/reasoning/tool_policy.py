...
# Pure/general information tools that do not expose Protagine's private stores.
...
_PRIVATE_READ_TOOLS = frozenset({
    "action_journal",
    "belief_conflicts",
    "protagine_discover_connections",
    "protagine_get_briefing",
    "protagine_get_relationship",
    "protagine_list_boundaries",
    "protagine_list_goals",
    "protagine_memory_search",
    "protagine_query_entities",
    "protagine_recent_boundary_blocks",
    "list_directory",
    "list_projects",
...
_MUTATION_TOOLS = frozenset({
    "abandon_project",
    "protagine_flag_boundary_concern",
    "protagine_initiative_feedback",
    "protagine_record_insight",
    "protagine_start_research",
