"""Custom subtask handler for the Protagine task queue.
...
_SYSTEM_PROMPT = (
    "You are an Protagine subtask worker with NO tools: you cannot browse, run "
...
class SubtaskHandler(JobHandler):
    ...
    async def _run_agent(
        ...
        try:
            from protagine_cli.model_config import load_model_registry
