...
for the Protagine hardware-aware distributed job scheduler.
"""
...
@dataclass
class FederatedJob:
    """A job posted by a federated peer protagine."""

    job: Job
    source_protagine_id: str
    source_protagine_trust_level: int
    signature: str           # Ed25519 signature from source protagine
