"""Mesh layer integration for the Protagine distributed task queue.
...
protagine/mesh/ layer without modifying it.
"""
...
class QueueMeshEventHandler:
    ...
    Subscribe this handler to the Protagine event bus for MeshEvent types.
    ...
    def subscribe_to_event_bus(self) -> None:
        """Register this handler on the Protagine event bus if one is configured."""
        if self._event_bus is None:
            return
        from protagine.events.types import MeshEvent
