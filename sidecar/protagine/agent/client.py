"""Protagine Agent Client — WebSocket client for remote agents.

Usage:
    from protagine.agent import AgentClient

    client = AgentClient(config_path="~/.protagine/agent.json")
...
class AgentClient:
    """WebSocket client for remote Protagine agents.
    ...
    def __init__(
        self,
        config_path: str = "~/.protagine/agent.json",
    ...
    async def start(self) -> None:
        """Connect to Protagine and start message loop."""
    ...
    async def _connect(self) -> None:
        ...
        print(f"Connected to Protagine: {self.config.websocket_url}")
    ...
    async def _heartbeat_loop(self) -> None:
        ...
        # The protagine side tracks current_assignments via the agents table
