...
training-corpus exporter. Data never leaves PROTAGINE_STATE_DIR.
"""
...
from protagine.mining.models import EscalationRecord, MinedTurn
...
class MiningStore:
    ...
    def prune_turns(self, *, retention_days: int = 0,
        ...
        PROTAGINE_MINING_RETENTION_DAYS / PROTAGINE_MINING_MAX_TURNS. Escalation
