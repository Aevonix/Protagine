...
PROTAGINE_MINING_TURN_CAP
    Per-side verbatim capture cap in chars (default 8000).
PROTAGINE_CORPUS_EXPORT_ENABLED
...
def heavy_model_regex() -> str:
    return os.environ.get("PROTAGINE_ESCALATION_HEAVY_RE", "")


def turn_cap() -> int:
    try:
        return max(500, int(os.environ.get("PROTAGINE_MINING_TURN_CAP", "8000")))
    except ValueError:
        return 8000
