"""Protagine Research-to-Artifact Pipeline (RAP).
...
Usage::
    ...
    from protagine.research import ResearchPipeline, ArtifactFormat
...
from protagine.research.artifact import ArtifactFormat, Artifact
from protagine.research.gatherer import EvidenceItem, EvidencePackage, SourceType
from protagine.research.synthesizer import SynthesisReport
from protagine.research.pipeline import ResearchPipeline, PipelineRun, PipelineStage, PipelineStatus
