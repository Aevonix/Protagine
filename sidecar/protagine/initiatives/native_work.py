...
def contract(row):
    ...
    instructions = (
        'Perform one internal read-only evidence review with protagine_read_work_source. '
        ...
        'Complete with protagine_review_report(disposition="complete", summary=...), which invokes '
