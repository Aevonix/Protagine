"""Protagine Graph Schema — Node and edge type definitions.

Every node and relationship type used in the Protagine Neo4j graph is modelled
...
class Owner(BaseModel):
    """The Protagine owner (singleton node — one per graph)."""
...
class Agent(BaseModel):
    """An autonomous entity (Protagine itself, or other agents/bots)."""
...
class Subsystem(BaseModel):
    """A Protagine component that can be monitored and restarted."""
...
class Capability(BaseModel):
    """A tool or skill that Protagine has or needs."""
...
class Concept(BaseModel):
    """A knowledge domain or concept Protagine has encountered."""
...
class EdgeType(str, Enum):
    """All relationship types in the Protagine graph."""
