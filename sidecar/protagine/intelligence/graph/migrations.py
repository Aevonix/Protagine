"""Protagine Graph Schema Migrations.

Applies Neo4j constraints and indexes required by the Protagine graph memory
...
(see protagine/vector/), so these migrations create no vector index.
"""
...
# ──────────────────────────────────────────────────────────────────────
# Schema V1 — initial Protagine graph schema
# ──────────────────────────────────────────────────────────────────────
...
async def run_migrations(
    ...
    """Apply all Protagine graph schema migrations.
    ...
    Args:
        ...
        embedding_dimensions: Kept for API compat; vector index creation
            is now handled by LanceDB (see protagine/vector/).
    ...
    logger.info(
        ...
        "Vector search handled by LanceDB — run 'protagine vector setup' to configure.",
