"""Protagine Skills — data models for the self-creating skills subsystem."""
...
@dataclass
class SkillManifest:
    """Complete metadata for a Protagine skill.

    Stored as protagine.skill.json alongside the skill source.
    """
    skill_id: str
    name: str
    version: str
    description: str
    author_protagine_id: str
    created_at: datetime
    updated_at: datetime
    ...
    def to_json(self) -> str:
        """Serialize to JSON for storage as protagine.skill.json."""
        d = {
            "skill_id": self.skill_id,
            "name": self.name,
            "version": self.version,
            "description": self.description,
            "author_protagine_id": self.author_protagine_id,
    ...
    def from_json(cls, raw: str) -> "SkillManifest":
        ...
        return cls(
            ...
            author_protagine_id=d["author_protagine_id"],
