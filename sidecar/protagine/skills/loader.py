"""Protagine Skills — on-demand skill module loader."""
...
from protagine.skills.budget import ContextBudget
from protagine.skills.index import SkillEntry, SkillIndex
...
_ALLOWED_LAZY_LOADER_PREFIXES = frozenset({"protagine.skills.", "protagine.plugins."})
