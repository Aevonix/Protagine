"""Protagine Skills — packaging extracted patterns as skill directories."""
...
from protagine.skills.learning.pattern_extractor import ExtractedPattern
from protagine.skills.learning.triggers import TriggerSource
from protagine.skills.models import SkillCapability, SkillManifest, SkillPermissions, SkillStatus
from protagine.skills.registry import SkillRegistry

logger = logging.getLogger(__name__)

_SLUG_RE = re.compile(r"[^a-z0-9-]")
_SKILL_LIBRARY_PATH = pathlib.Path("protagine/skills/library")
...
class SkillPackager:
    ...
    async def package(
        ...
        manifest = SkillManifest(
            ...
            author_protagine_id=self._protagine_id,
            created_at=now,
            updated_at=now,
        ...
        (skill_dir / "protagine.skill.json").write_text(manifest.to_json(), encoding="utf-8")
