...
class GoalsSeeder:
    ...
    async def seed(self, corpus: Any) -> None:
        try:
            ...
            from protagine.goals.models import Goal, GoalStatus, GoalSource, GoalPriority, GoalOutcome
        ...
        bootstrap_goal_id = f"goal-bootstrap-selfknowledge-{protagine_id[:8]}"
        try:
        ...
        goals = [
            Goal(
                ...
                description=(
                    ...
                    "refresh the self-knowledge corpus when Protagine is updated, "
            ...
            Goal(
                goal_id=f"goal-bootstrap-health-{protagine_id[:8]}",
                title="Maintain system health",
                description=(
                    "Monitor and maintain Protagine subsystem health. "
                ...
                outcome=GoalOutcome(
                    description="All Protagine subsystems operational.",
                    success_criteria=[
            ...
            Goal(
                goal_id=f"goal-bootstrap-learning-{protagine_id[:8]}",
