...
def provider_calibration_metadata(provider) -> dict[str, Any]:
    ...
    return {
        **provider.calibration_metadata(),
        "weights_revision": os.environ.get("PROTAGINE_RERANKER_REVISION", "unverified"),
        "embedding_model": os.environ.get("PROTAGINE_EMBED_MODEL", ""),
        "embedding_dimensions": os.environ.get("PROTAGINE_EMBED_DIMS", ""),
        "index_generation": os.environ.get("PROTAGINE_RECALL_INDEX_GENERATION", "unverified"),
