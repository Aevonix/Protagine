"""Cognition prompt templates for Protagine's background thinking.

The cognition prompt tells the subagent what Protagine can do and how to
...
_GUIDE = """\
You have access to Protagine's API through HTTP endpoints running on the same \
