...
is projected into Protagine's existing durable host event journal.
"""
...
def validate_external_journal_projection(
    ...
    configured_owner = (
        os.environ.get("PROTAGINE_OWNER_PERSON_ID", "")
    ...
    def __init__(
        ...
        *,
        ...
        if journal_acknowledger is None:
            from protagine.events.journal import acknowledge_event_record
