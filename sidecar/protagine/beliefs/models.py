...
def beliefs_supervised_live() -> bool:
    ...
    PROTAGINE_SUPERVISED_LIVE_DOMAINS=beliefs and the legacy
    PROTAGINE_BELIEFS_SUPERVISED_LIVE=1 are equivalent."""
...
def stale_ttl_days() -> float:
    try:
        return max(1.0, float(os.environ.get("PROTAGINE_BELIEFS_STALE_DAYS", "90")))
