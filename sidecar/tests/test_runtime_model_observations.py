...
from colony_sidecar.self_model import runtime_models as models
...
def test_outcome_retains_model_dependency_so_forgetting_retracts_derived_metadata(runtime):
    from colony_sidecar.self_model.runtime_forecasts import _retain, _current, _identity, VERSION
    import time
