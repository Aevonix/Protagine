...
class TestComputeEffectiveConfidence:
    def test_user_assertion_max_confidence(self):
        ...
        conf = ProtagineGraph.compute_effective_confidence(
            base_confidence=1.0,
    ...
    def test_corroboration_vs_contradiction(self):
        now = datetime.now(timezone.utc)
        conf_corro = ProtagineGraph.compute_effective_confidence(
            base_confidence=0.5,
        ...
        conf_contra = ProtagineGraph.compute_effective_confidence(
            base_confidence=0.5,
            source_reliability=0.9,
            corroboration_count=0,
    ...
    def test_contradiction_penalty(self):
        now = datetime.now(timezone.utc)
        conf_base = ProtagineGraph.compute_effective_confidence(
            base_confidence=0.8,
            source_reliability=0.9,
            corroboration_count=0,
            contradiction_count=0,
        ...
        conf_penalty = ProtagineGraph.compute_effective_confidence(
            base_confidence=0.8,
            source_reliability=0.9,
            corroboration_count=0,
    ...
    def test_recall_reinforcement(self):
        now = datetime.now(timezone.utc)
        conf_0 = ProtagineGraph.compute_effective_confidence(
            base_confidence=0.8,
            source_reliability=0.9,
            corroboration_count=0,
            contradiction_count=0,
        ...
        conf_10 = ProtagineGraph.compute_effective_confidence(
            base_confidence=0.8,
            source_reliability=0.9,
            corroboration_count=0,
            contradiction_count=0,
    ...
    def test_recency_discount(self):
        ...
        conf_old = ProtagineGraph.compute_effective_confidence(
            base_confidence=1.0,
        ...
        conf_new = ProtagineGraph.compute_effective_confidence(
            base_confidence=1.0,
            source_reliability=1.0,
            corroboration_count=0,
            contradiction_count=0,
    ...
    def test_verification_boost(self):
        now = datetime.now(timezone.utc)
        conf_no_verify = ProtagineGraph.compute_effective_confidence(
            base_confidence=0.8,
            source_reliability=0.9,
            corroboration_count=0,
            contradiction_count=0,
        ...
        conf_verified = ProtagineGraph.compute_effective_confidence(
            base_confidence=0.8,
            source_reliability=0.9,
            corroboration_count=0,
            contradiction_count=0,
