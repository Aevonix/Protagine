...
from protagine.agents.models import Agent, AgentStatus, AgentMetadata
...
class TestAgentStore:
    ...
    def test_list_agents(self, store: AgentStore) -> None:
        ...
        # Filter by protagine_id
        protagine_agents = store.list(protagine_id="protagine-1")
        assert len(protagine_agents) == 3
...
class TestInviteStore:
    ...
    def test_create_invite(self, store: InviteStore) -> None:
        ...
        assert invite["setup_code"].startswith("PROTAGINE-")
