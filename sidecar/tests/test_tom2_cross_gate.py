...
render_for_contact is the double gate (PROTAGINE_TOM2_CROSS_CONTEXT=1 AND every
...
from protagine.tom.tom2 import (
...
async def test_no_live_injection_even_with_every_flag_on(stores,
    ...
    carries zero tom2 content unless the LEVELED system (PROTAGINE_TOM2_LEVEL,
