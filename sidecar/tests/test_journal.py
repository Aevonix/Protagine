...
from protagine.events.journal import (
...
def journal_dir(tmp_path, monkeypatch):
    ...
    d = tmp_path / "events"
    d.mkdir()
    monkeypatch.setenv("PROTAGINE_EVENT_JOURNAL_DIR", str(d))
...
class TestAppendEvent:
    ...
    def test_append_prunes_old_events(self, journal_dir, monkeypatch):
        monkeypatch.setenv("PROTAGINE_EVENT_JOURNAL_RETENTION", "5")
    ...
    def test_append_event_returns_minus_one_on_failure(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("PROTAGINE_EVENT_JOURNAL_DIR", "/dev/null/impossible")
    ...
    def test_steady_state_append_uses_cursor_not_directory_scan(
        ...
        from protagine.events import journal
