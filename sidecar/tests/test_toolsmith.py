...
from protagine.toolsmith.engine import Toolsmith
from protagine.toolsmith.miner import ToolsmithMiner, _normalize
from protagine.toolsmith.registry import ToolRegistry, ToolStatus
...
async def _client(ts, authority=None):
    ...
    async def _bind_authority(request, call_next):
        request.state.protagine_authority = (
