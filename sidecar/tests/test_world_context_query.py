"""World-context query mode (U18): PROTAGINE_WORLD_CONTEXT_QUERY=message/entities.
...
async def test_default_mode_is_single_whole_message_call(monkeypatch):
    ...
    monkeypatch.delenv("PROTAGINE_WORLD_CONTEXT_QUERY", raising=False)
...
async def test_entities_mode_ors_per_candidate_lookups(monkeypatch):
    monkeypatch.setenv("PROTAGINE_WORLD_CONTEXT_QUERY", "entities")
