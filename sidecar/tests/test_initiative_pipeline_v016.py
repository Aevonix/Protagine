...
class TestInitiativeSerializer:
    ...
    def test_title_is_action_not_reason(self):
        from protagine.api.routers.host import _initiative_to_response
...
class TestIdentityResolver:
    ...
    def test_legacy_env_var_shim(self, monkeypatch):
        monkeypatch.delenv("PROTAGINE_OWNER_CONTACT_ID", raising=False)
        monkeypatch.setenv("PROTAGINE_HOST_CONTACT_ID", "cid-legacy")
        assert get_owner_contact_id() == "cid-legacy"

        monkeypatch.setenv("PROTAGINE_OWNER_CONTACT_ID", "cid-canonical")
