...
from protagine.cognition.charter import (
...
def _trust(wins=0, losses=0, stage=None, domain="research"):
    from protagine.self_model import ActionJournal, CompetenceStore, TrustEngine
...
def test_golden_stated_vs_realized_calibration():
    from protagine.self_model import CompetenceStore
    s = CompetenceStore()
