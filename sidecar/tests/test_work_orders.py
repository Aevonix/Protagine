...
from protagine.workers.queue_worker import AGENT_ACTION_CAPABILITIES
...
def test_receipt_verifier_loader_builds_exact_configured_factory(monkeypatch):
    ...
    verifier = load_receipt_verifier_from_env({
        "PROTAGINE_WORK_ORDER_RECEIPT_VERIFIER": "test_plugin:factory.Verifier",
        "PROTAGINE_WORK_ORDER_RECEIPT_VERIFIER_CONFIG": (
...
@pytest.mark.parametrize("environment", [
    {"PROTAGINE_WORK_ORDER_RECEIPT_VERIFIER": "not-an-import"},
    {
        "PROTAGINE_WORK_ORDER_RECEIPT_VERIFIER": "plugin:Verifier",
        "PROTAGINE_WORK_ORDER_RECEIPT_VERIFIER_CONFIG": "[]",
    },
    {
        "PROTAGINE_WORK_ORDER_RECEIPT_VERIFIER": "plugin:Verifier",
        "PROTAGINE_WORK_ORDER_RECEIPT_VERIFIER_CONFIG": "{broken",
    },
])
...
async def test_queue_work_order_is_neutral_until_independent_attestation(
    ...
    monkeypatch.setenv("PROTAGINE_WORKERS_MODE", worker_mode)
...
def test_startup_fence_is_narrow_to_declared_cognition_work_orders():
    from protagine.server import _cognition_work_order_startup_hold_reason
