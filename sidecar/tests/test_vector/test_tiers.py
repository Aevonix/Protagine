"""Tests for protagine.vector.tiers — tier definitions and selection."""
import pytest
from protagine.vector.tiers import TIERS, TierConfig, ModelSpec, get_tier, get_tier_by_memory
