"""protagine_queue_stats returns a fixed count-only projection.
...
def _load_plugin(name: str = "protagine_hermes_queue_stats_projection_test"):
...
def test_projection_keeps_counts_and_drops_text():
    ...
    assert out["schema"] == "ProtagineQueueStatsProjectionV1"
