"""The canonical Hermes plugin forwards host turn IDs to Protagine V2."""
...
def _load_client_module():
    name = "protagine_hermes_client_turn_id_test"
...
def test_stable_turn_id_uses_v2_put_and_is_url_escaped(monkeypatch):
    ...
    client = module.ProtagineClient(url="http://sidecar.test")
    calls = []
    monkeypatch.setattr(
        client,
        "put",
