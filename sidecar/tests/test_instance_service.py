...
from protagine.services.instance import InstanceService, ServiceError
...
def test_existing_service_keeps_its_identity_during_environment_upgrade(service_factory, platform):
    ...
    label = 'ai.protagine.instance.' + suffix
    name = label+'.plist' if platform=='darwin' else 'protagine-'+suffix+'.service'
