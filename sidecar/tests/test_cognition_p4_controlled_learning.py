...
from protagine.intelligence.cognition.strategy_adjuster import StrategyAdjuster
from protagine.intelligence.cognition.gap_detector import (
    Gap,
    GapDetector,
    GapType,
)
from protagine.intelligence.cognition.types import GapSeverity
from protagine.intelligence.cognition.performance_index import (
...
async def test_legacy_gap_detector_can_only_persist_a_typed_proposal(
    ...
    monkeypatch.setenv("PROTAGINE_COGNITION_P4_MODE", "shadow")
