...
def _clean(text: str, redact: bool) -> str:
    ...
    try:
        from apsimo.delivery.reachout_policy import sanitize_text
    ...
    if redact:
        try:
            from apsimo.redact import redact_sensitive_text
...
def _system_origin(text: str) -> bool:
    try:
        from apsimo.delivery.reachout_policy import is_system_origin
