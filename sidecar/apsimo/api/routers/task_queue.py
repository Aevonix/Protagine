...
from apsimo.task_queue.queue_manager import (
    QueueExecutionUnavailable,
    TaskQueueManager,
)
from apsimo.util.session_safety import (
...
async def queue_contract(request: Request = None) -> Dict[str, Any]:
    ...
    from apsimo.task_queue.contract import (
...
async def create_job(body: JobPostRequest) -> Dict[str, Any]:
    ...
    if job_type is JobType.AGENT_ACTION:
        from apsimo.initiatives.action_registry import get_action
