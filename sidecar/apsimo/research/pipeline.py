...
from apsimo.research.gatherer import EvidencePackage, GatherConfig, SourceGatherer
from apsimo.research.synthesizer import ResearchSynthesizer, SynthesisConfig, SynthesisReport
from apsimo.research.artifact import (
    Artifact,
    ArtifactFormat,
    ArtifactOutline,
    ArtifactRenderer,
...
class ResearchPipeline:
    ...
    async def _run_review_gate(
        ...
        try:
            from apsimo.gate.layers.l2_pii import PIIScanner
            from apsimo.gate.layers.l5_injection import InjectionDetector
            from apsimo.gate.config import GateConfig
            from apsimo.gate.models import GatePayload, TrustTier
