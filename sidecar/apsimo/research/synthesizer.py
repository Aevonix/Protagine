...
from apsimo.research.gatherer import EvidenceItem, EvidencePackage, SourceType
...
class ResearchSynthesizer:
    ...
    async def _run_colony_synthesis(
        ...
        from apsimo.intelligence.synthesis.cross_domain_analyzer import CrossDomainAnalyzer
        from apsimo.intelligence.synthesis.novelty_scorer import NoveltyScorer
        from apsimo.intelligence.synthesis.insight_validator import InsightValidator
