...
from apsimo.contacts.transport_ingress import TransportIngress
...
def _parent_current(ledger, commitments, conditions, owner):
    from apsimo.api.routers.temporal_followups import source_bindings
...
def _stop_facts(ledger, commitments, prediction, now):
    ...
    from apsimo.commitments.store import OPEN_STATUSES
    c = prediction.detail['conditions']
