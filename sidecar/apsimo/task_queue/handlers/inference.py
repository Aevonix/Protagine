...
from apsimo.task_queue.handlers.base import JobHandler, Job
...
if TYPE_CHECKING:
    ...
    from apsimo.contacts.models import Contact
...
async def _update_world_model_async(
    ...
    """
    try:
        from apsimo.world_model.extraction.conversation_extractor import ConversationExtractor
    ...
    async def _gate_context(
        ...
        *,
        ...
        try:
            ...
            from apsimo.contextgate import GateDecision
