...
from apsimo.router.complexity_scorer import ComplexityScorer
from apsimo.router.fallback import FallbackHandler
from apsimo.router.self_learning import RouterSelfLearner
from apsimo.router.tiers import DEFAULT_TIERS, ModelTier, TierConfig
...
class LLMRouter:
    ...
    async def _call_function(self, snapshot, messages, context, tools, force_tier, stream, request_id):
        ...
        from apsimo.contextgate import estimate_tokens
