...
class EmbeddingPipeline:
    ...
    def index_identity(self):
        from apsimo.vector.indexes import EmbeddingIdentity
    ...
    def _check_identity(self):
        if self._index_identity is not None:
            from apsimo.vector.indexes import EmbeddingIdentity, IncompatibleIndex
    ...
    async def embed_image(self, source: str | bytes, mime_type: str = "", caption: str = "") -> tuple[list[float], dict[str, Any]]:
        ...
        from apsimo.vector.multimodal_types import EmbedInput, Modality
        from apsimo.vector.image_preprocess import (
            compute_image_hash, extract_exif, load_image, resize_image,
            strip_gps_exif, validate_image,
        )
        from apsimo.vector.safety_image import check_image, ImageCheckLevel
        ...
        if not caption:
            from apsimo.vector.caption import caption_image
