...
from apsimo.tools.definitions import STATIC_TOOL_NAMES, get_tool_definitions
from apsimo.tools.handlers import TOOL_HANDLERS
from apsimo.reasoning.tool_policy import (
    ToolActorPolicy,
    ToolEffect,
    action_target,
    actor_allows_effect,
...
class ToolExecutor:
    ...
    def register_native_tools(self, search_orchestrator=None, sandbox_dir: str = "") -> None:
        ...
        if sandbox_dir:
            try:
                from apsimo.reasoning.native_tools.file_ops import (
