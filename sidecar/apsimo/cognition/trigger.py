...
from apsimo.cognition.prompt import COGNITION_SYSTEM_PROMPT, build_cognition_prompt
...
def _cognition_enabled() -> bool:
    from apsimo.util.autonomy_preset import resolve_bool
...
async def trigger_cognition(
    ...
    if person_id:
        try:
            from apsimo.api.routers.host import _commitment_store
...
def _emit_cognition_event(
    ...
    """
    try:
        from apsimo.events.broadcaster import emit
