...
from apsimo.connectors.base import Connector, Observation
...
class ConnectorManager:
    ...
    def register_default_connectors(self) -> int:
        ...
        from apsimo.connectors.caldav_calendar import CalendarConnector
        from apsimo.connectors.fs_documents import FSDocumentsConnector
        from apsimo.connectors.webhook_pull import WebhookPullConnector
