...
from apsimo.beliefs.contradictions import (
    claims_from_text, detect_conflicts, property_claims,
)
from apsimo.beliefs.decay import decay_entity, stale_entities
from apsimo.beliefs.models import Claim, beliefs_mode
from apsimo.beliefs.resolve import pick_winner
...
class BeliefEngine:
    ...
    def note_property_update(self, entity_id: str, key: str,
        ...
        from apsimo.beliefs.models import norm_value
    ...
    def _effective_mode(self) -> str:
        ...
        from apsimo.self_model.supervised import effective_mode
