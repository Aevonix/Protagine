...
class ExecutionRegistry:
    ...
    def observe(self, value: dict, *, principal_id: str, contact_id: str) -> dict:
        from apsimo.self_model.execution_forecasts import safe_reconcile
        ...
        with closing(self.ledger._connect()) as conn, conn:
            ...
            from apsimo.self_model.execution_forecasts import accumulate
        ...
        from apsimo.self_model.execution_forecasts import safe_observe
        ...
        for row in rows:
            ...
            if include_inputs and metadata.get('input_refs'):
                ...
                if subject == contact_id:
                    try:
                        from apsimo.turns.source_read import input_excerpt
            ...
            if owner:
                from apsimo.self_model.execution_forecasts import project
    ...
    for source, group in groups:
        ...
        for is_recent, row in [(False, row) for row in group.get('items', [])] + [
            ...
            if source == 'reported_worker':
                from apsimo.turns.reported_workers import work_details
