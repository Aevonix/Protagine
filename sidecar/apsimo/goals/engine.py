...
from apsimo.goals.decomposer import GoalDecomposer
from apsimo.goals.inference import (
    ConversationMessage,
    GoalDeduplicator,
...
from apsimo.goals.priority import GoalProgressTracker, GoalPriorityScorer, UserPreferenceProfile
from apsimo.goals.queue_bridge import GoalQueueBridge
from apsimo.goals.replan import (
    FailureAnalysis,
    ReplanEngine,
    ReplanResult,
    ReplanStrategy,
)
from apsimo.goals.store import GoalNotFoundError, GoalStore
from apsimo.task_queue.models import JobResult
...
class GoalEngine:
    ...
    def get_active_summary(self) -> List[GoalSummary]:
        ...
        for goal in active_goals:
            ...
            from apsimo.goals.models import SubtaskStatus
            completed = (
    ...
    def trigger_replan(
        ...
        if failed is None:
            ...
            from apsimo.goals.replan import FailureAnalysis, FailureClass
