...
def _cognition_owner_spec(*, router, node_id: str):
    ...
    from apsimo.task_queue.models import JobType, WorkerCapabilities
    from apsimo.task_queue.routing import THOUGHT_ROUTE
...
def _attach_p8_runtime(*, state_dir: Path, facts_store, graph=None):
    ...
    from apsimo.tom.integration import P8Runtime, p8_integration_mode
    ...
    audit = None
    try:
        from apsimo.tom.arcs import ArcStore
...
def _work_order_runtime_hold_reason(job, project_store, concern_store) -> str:
    ...
    from apsimo.task_queue.models import JobType
...
def _attach_cognition_spine(
    *,
    ...
    def _runtime_contract():
        ...
        from apsimo.self_model.event_concerns import event_concern_mode
        from apsimo.self_model.workspace import workspace_mode
...
def _scheduler_health_check(autonomy_loop) -> dict:
    ...
    """
    import apsimo.api.routers.host as _h
    wired = 0
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        try:
            from apsimo.api.routers.host import set_adaptive_params
    ...
    if os.environ.get("COLONY_GRAPH_ENABLED", "true").lower() not in {"0", "false", "off"}:
        try:
            ...
            try:
                from apsimo.intelligence.graph.migrations import run_migrations
            ...
            try:
                import apsimo.api.routers.host as _host_router
    ...
    _gate_audit = None
    try:
        from apsimo.gate import ResponseGate, GateConfig
        from apsimo.gate.audit import InMemoryAuditLog
    ...
    if graph is not None:
        try:
            from apsimo.intelligence.mind_model.graph_baseline import GraphBaselineStore
            from apsimo.intelligence.mind_model.signal_collector import SignalCollector
    ...
    if embed_provider != "skip" and (not embed_provider or not embed_model):
        try:
            ...
            from apsimo.vector.tiers import get_tier_by_memory
            hw = scan()
        ...
        if provider is None:
            ...
            if multimodal_enabled:
                try:
                    ...
                    from apsimo.vector.image_store import make_image_store
            ...
            try:
                ...
                from apsimo.vector import set_store, set_pipeline
    ...
    try:
        ...
        from apsimo.self_model.settlement import register_settler
    ...
    try:
        ...
        from apsimo.api.routers.host import set_tom2_store, set_tom2_engine
        ...
        from apsimo.api.routers.host import set_tom2_exposure_store
        ...
        from apsimo.api.routers.host import set_presence_store
        ...
        # no bypass authority.
        from apsimo.gate.response_guard import ResponseGuard, GuardMode
        from apsimo.gate.surface_policy import (
            POLICY_DIGEST as _guard_policy_digest,
            POLICY_ID as _guard_policy_id,
        )
        from apsimo.world_model.extraction.conversation_extractor import (
        ...
        from apsimo.api.routers.host import set_taint_registry
        ...
        from apsimo.tom.levels import set_evidence_probe
    ...
    try:
        ...
        from apsimo.api.routers.host import set_directive_manager
        from apsimo.turns import get_turn_idempotency_ledger
    ...
    try:
        ...
        from apsimo.api.routers.host import set_proposal_store
    ...
    try:
        ...
        from apsimo.api.routers.host import set_feedback_store
    ...
    try:
        ...
        if self_model_enabled():
            from apsimo.autonomy.registry import SubsystemRegistry as _Reg
    ...
    try:
        from apsimo.toolsmith import (
            Toolsmith, ToolRegistry, toolsmith_enabled,
        )
        from apsimo.api.routers.host import set_toolsmith
        if toolsmith_enabled():
            ...
            try:
                from apsimo.api.routers.host import _tool_executor
    ...
    try:
        ...
        from apsimo.api.routers.host import set_expectations
        if expectations_enabled():
            _exp_store = ExpectationStore(
                db_path=str(state_dir / "colony-expectations.db"))
            _exp_journal = None
            try:
                from apsimo.api.routers.host import _self_model as _sm_e
    ...
    try:
        ...
        from apsimo.self_model.thinker import build_thinker
        from apsimo.self_model.event_concerns import (
        ...
        from apsimo.api.routers.host import set_workspace
        if workspace_enabled():
            ...
            _ws_journal = None
            try:
                from apsimo.api.routers.host import _self_model as _sm_ws
    ...
    try:
        from apsimo.skills_memory import SkillStore, skills_distill_mode
        from apsimo.api.routers.host import set_skill_store
    ...
    try:
        from apsimo.mining import EscalationMiner, MiningStore, mining_mode
        from apsimo.api.routers.mining import set_mining
    ...
    try:
        from apsimo.repos import RepoMirrorManager
        ...
        if _n_repos:
            ...
            async def _sync_mirrors():
                try:
                    ...
                    from apsimo.api.routers.host import _world_store as _ws
        ...
        async def _directed_deliver(payload: dict) -> bool:
            ...
            try:
                from apsimo.api.routers.host import _autonomy_loop, _delivery_bridge
        ...
        from apsimo.api.routers.host import _feedback_store as _fb_store
    ...
    try:
        ...
        from apsimo.channels.router import set_channel_store
        ...
        from apsimo.api.routers.host import set_channel_store as _host_set_channel_store
    ...
    if contacts_store is not None:
        try:
            ...
            import apsimo.api.routers.host as _host_mod
    ...
    # --- 9. Briefings ---
    try:
        from apsimo.briefings.engine import BriefingEngine
    ...
    try:
        ...
        try:
            from apsimo.world_model.populator import WorldModelPopulator, populate_mode
            from apsimo.api.routers.host import (
        ...
        try:
            from apsimo.beliefs import BeliefEngine, BeliefStore, beliefs_mode
            from apsimo.api.routers.host import set_belief_engine
            from apsimo.world_model.store import set_property_audit_hook
        ...
        try:
            ...
            from apsimo.world_model.extraction.formats import (
            ...
            if llm_router is not None:
                try:
                    from apsimo.world_model.extraction.llm_extractor import (
    ...
    try:
        from apsimo.intelligence.cognition.registry import CognitionPipeline
    ...
    try:
        ...
        if search_provider == "tavily" and os.environ.get("TAVILY_API_KEY"):
            from apsimo.research.search.tavily import TavilyProvider
            ...
            from apsimo.research.search.serpapi import SerpAPIProvider
            ...
            from apsimo.research.search.brave import BraveSearchProvider
    ...
    try:
        ...
        try:
            ...
            from apsimo.briefings.config import BriefingConfig
            from apsimo.briefings.engine import BriefingEngine
            from apsimo.briefings.scheduler import BriefingScheduler
            ...
            try:
                if graph is not None:
                    from apsimo.briefings.aggregators import RelationshipAggregator
    ...
    try:
        from apsimo.intelligence.synthesis.connection_discoverer import ConnectionDiscoverer
        if graph is not None:
    ...
    try:
        from apsimo.intelligence.learning.continuous_learner import ContinuousLearner
    ...
    # --- 17. Chain / Identity ---
    try:
        from apsimo.chain.identity import (
        ...
        from apsimo.chain.manager import ChainManager
        chain = ChainManager(
        ...
        try:
            from apsimo.chain.node import get_or_create_node_id, ensure_node_keypair, create_node_certificate
    ...
    # --- 19. Session store ---
    try:
        from apsimo.sessions.store import InMemorySessionStore
        ...
        if _gate_ref is not None:
            from apsimo.gate import ResponseGate
    ...
    try:
        ...
        try:
            ...
            from apsimo.api.routers.observations import set_observation_store
    ...
    try:
        ...
        if getattr(autonomy_config, "mode_source", "") == "preset":
            try:
                from apsimo.util.autonomy_preset import preset_name
            ...
            try:
                from apsimo.api.routers.host import _self_model as _sm_j
        ...
        async def _run_memory_consolidate():
            from apsimo.api.routers.host import _consolidator as c
            if c is None:
        ...
        async def _run_cpi_track():
            from apsimo.api.routers.host import _metalearner as ml
            if ml is None:
        ...
        async def _run_world_model_prune():
            from apsimo.api.routers.host import _world_store as ws
            if ws is None:
        ...
        async def _run_mining_prune():
            from apsimo.api.routers.mining import get_mining_store
        ...
        if os.environ.get("COLONY_PATTERNS_SCHEDULE",
            ...
            async def _run_pattern_extract():
                ...
                from apsimo.patterns.extract import extract_patterns
                return {"status": "ok",
        ...
        async def _run_surprise_ttl():
            from apsimo.api.routers.host import _surprise_store as ss
            if ss is None:
                return {"status": "skipped",
        ...
        async def _run_digest_flush():
            from apsimo.api.routers.host import _delivery_bridge as bridge
            if bridge is None:
    ...
    if registry is not None and locals().get("tool_executor") is not None:
        ...
        from apsimo.tools.handlers import TOOL_HANDLERS as _colony_handlers
    ...
    try:
        from apsimo.projects import ProjectEngine, ProjectStore, projects_mode
        ...
        try:
            from apsimo.api.routers.host import _belief_engine as _be
            if _be is not None:
    ...
    try:
        ...
        if _cognition_spine is not None:
            from apsimo.cognition.goal_spine import cognition_spine_mode
            logger.info(
    ...
    try:
        ...
        try:
            from apsimo.self_model.situation import situation_spine_mode
    ...
    try:
        ...
        from apsimo.task_queue.governor import WorkerGovernor, workers_mode
    ...
    try:
        from apsimo.services.agent_bridge import (
    ...
    if task_queue is not None and _embedded_worker_enabled():
        try:
            ...
            from apsimo.task_queue.worker import WorkerNode
    ...
    try:
        from apsimo.sandbox import SandboxManager, sandbox_mode
        from apsimo.api.routers.host import (
    ...
    try:
        ...
        from apsimo.api.routers.host import get_directive_manager as _get_dm
    ...
    from apsimo.sessions.reports import SessionReportStore
    ...
    try:
        if (
            ...
            from apsimo.autonomy.synthesis import ConversationSynthesisTask
    ...
    try:
        import apsimo.api.routers.host as _host_actions
        from apsimo.api.routers.governed_actions import (
    ...
    claims_enabled = os.environ.get("COLONY_SOURCE_CLAIMS", "on").strip().lower() in {"on", "1", "true"}
    from apsimo.vector import get_store as source_vector_store
    if claims_enabled or source_vector_store() is not None:
        from apsimo.turns import get_turn_idempotency_ledger
        from apsimo.beliefs.source_projection import run_source_claim_worker
        from apsimo.api.routers import host as source_claim_host
    ...
    try:
        from apsimo.channels.router import set_channel_store as _set_ch_store
        _set_ch_store(None)
    except Exception:
        pass
    ...
    try:
        from apsimo.api.routers.host import _autonomy_loop
    ...
    try:
        from apsimo.api.routers.host import set_project_engine
        set_project_engine(None)
        project_store = locals().get("_project_store")
...
def create_app() -> FastAPI:
    ...
    from apsimo.api.middleware import ApiKeyMiddleware, BodySizeLimitMiddleware
    ...
    from apsimo.api.routers import executions as executions_router
    app.include_router(executions_router.router)
    from apsimo.api.routers import commitment_work as commitment_work_router
    app.include_router(commitment_work_router.router)
    from apsimo.api.routers import initiative_work as initiative_work_router
    app.include_router(initiative_work_router.router)
    from apsimo.api.routers import social_state as social_state_router
    app.include_router(social_state_router.router)
    from apsimo.api.routers import temporal_followups as temporal_followups_router
    app.include_router(temporal_followups_router.router)
    from apsimo.api.routers import transport as transport_router
    app.include_router(transport_router.router)
    from apsimo.api.routers import followup_plans
    ...
    from apsimo.api.routers import governed_actions as governed_actions_router
    app.include_router(governed_actions_router.router)

    # Channel registration router
    from apsimo.channels.router import router as channels_router
    app.include_router(channels_router)

    # Task queue router (v0.13.0)
    from apsimo.api.routers import task_queue as task_queue_router
    app.include_router(task_queue_router.router)

    # Observations router (v0.16.0) — agent-as-sensor ingestion
    from apsimo.api.routers import observations as observations_router
    app.include_router(observations_router.router)
    from apsimo.api.routers import mining as mining_router
    app.include_router(mining_router.router)

    # Context gate (v0.32.0) — budget-aware context preparation
    from apsimo.api.routers import context_gate as context_gate_router
