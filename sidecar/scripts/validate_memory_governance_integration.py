...
from protagine.intelligence.graph.client import (
    ProtagineGraph,
    GraphConfig,
    EpistemicState,
    MemorySourceType,
...
async def cleanup(graph: ProtagineGraph) -> None:
...
async def step_connect() -> ProtagineGraph:
    ...
    graph = ProtagineGraph(config)
    await graph.connect()
    log("  Connected ✓")
    return graph


async def step_store_memory_basic(graph: ProtagineGraph) -> str:
...
async def step_store_memory_file_anchor(graph: ProtagineGraph) -> str:
...
async def step_store_memory_user_assertion(graph: ProtagineGraph) -> str:
...
async def step_compute_effective_confidence(graph: ProtagineGraph) -> None:
...
async def step_touch_memory(graph: ProtagineGraph, mid: str) -> None:
    log("touch_memory...")
...
async def step_decay_memories(graph: ProtagineGraph, mid_weak: str) -> None:
    log("decay_memories...")
...
async def step_verify_memory(graph: ProtagineGraph, mid: str) -> None:
    log("verify_memory...")
...
async def step_transition_epistemic_state(graph: ProtagineGraph, mid: str) -> None:
...
async def step_prune_weak_memories(graph: ProtagineGraph) -> str:
...
async def step_archive_memories(graph: ProtagineGraph) -> str:
...
async def step_recall_filters_terminal(graph: ProtagineGraph) -> None:
