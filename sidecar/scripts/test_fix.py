...
from protagine.intelligence.components.initiative_engine import InitiativeEngine, InitiativeConfig
...
async def main():
    uri = os.environ.get("PROTAGINE_NEO4J_URI", "bolt://localhost:7687")
    user = os.environ.get("PROTAGINE_NEO4J_USER", "neo4j")
    password = os.environ.get("PROTAGINE_NEO4J_PASSWORD", "password")
