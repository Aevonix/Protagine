"""Colony sidecar setup wizard - ``colony-sidecar init``.
...
def _write_env(env_path: Path, values: dict[str, str]) -> None:
    lines = [
        ...
        "# Generated by 'colony-sidecar init'",
        "",
    ]
...
def run_init(root_dir: str | None = None) -> int:
    ...
    print(f"    {_green('colony-sidecar start')}")
    print()
    host_val = values["COLONY_SIDECAR_HOST"]
    port_val = values["COLONY_SIDECAR_PORT"]
    print(f"  Or with options:")
    print(f"    {_green(f'colony-sidecar start --host {host_val} --port {port_val}')}" )
    print()
    print("  Check health:")
    print(f"    {_green('colony-sidecar status')}")
    print()
    print("  Your API key:")
